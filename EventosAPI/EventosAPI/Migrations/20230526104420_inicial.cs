    ...
    public partial class inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Eventos_Usuarios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Eventos_Usuarios_Eventos_EventoId",
                        column: x => x.EventoId,
                        principalTable: "Eventos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Eventos_Usuarios_Usuarios_UsuarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Eventos_Usuarios_EventoId",
                table: "Eventos_Usuarios",
                column: "EventoId");

            migrationBuilder.CreateIndex(
                name: "IX_Eventos_Usuarios_UsuarioId",
                table: "Eventos_Usuarios",
                column: "UsuarioId");
        }
